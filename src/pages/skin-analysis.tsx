...
import { extractSkinAnalysisResults, getGranularLevel } from "@/util/utils";
        ...
        >
          ...
          {analyzing && (
            <div style={{ textAlign: "center", margin: "1rem" }}>
              ...
              />
              <p style={{ marginTop: "0.5rem" }}>Analyzing skin features...</p>
            </div>
          )}
          ...
          {processedImagePreview && (
            <div style={{ marginBottom: "1rem" }}>
              <h3>Processed Image (1920x480):</h3>
              <img
